    ...
    <transition name="card" mode="out-in">
      <div class="card" v-if="frontCard" key="front">
        <header class="card-header">
          <p class="card-header-title title">{{ projects[title]["frontTitle"] }}</p>
        </header>
        ...
        <div class="card-content">
          <p class="sub-title text-content">{{ projects[title]["frontContent"] }}</p>
          <br />
          <div class="container">
            <a
              v-if="title != 0"
      ...
      <div class="card" v-if="!frontCard" key="back">
        ...
        <div class="card-content">
          <div class="content">
            <ul>
              <li v-for="item in projects[title]['languages']" :key="item.id">{{ item }}</li>
            </ul>
          </div>
